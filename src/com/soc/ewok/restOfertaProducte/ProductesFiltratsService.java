...
public class ProductesFiltratsService {
	...
	/**
	 * Service que retorna la coleccio de productes de una categoria 
	 * @param id Identificador de la categoria
	 * @return Retorna una List de Productes, o un objecte Producte 
	 * quan nomes ni a un a la bd, o null si no n'hi ha cap
	 * @throws SQLException
	 * s'arriba a aquest metode per eWok/data/productesfiltrats/unTipusdeProductes
	 */
	@GET
	 ...
	 * @throws SQLException
	 * s'arriba a aquest metode per eWok/data/productesfiltrats/unProducteCompost
	 */
	@GET
	...
	/**
	 * Service que retorna la coleccio de productes que un Producte compost
	 * pot usar 
	 * @param id Identificador de la categoria del producte compost
	 * @return Retorna una List de Productes, o un objecte Producte 
	 * quan nomes ni a un a la bd, o null si no n'hi ha cap
	 * @throws SQLException
	 * s'arriba a aquest metode per eWok/data/productesfiltrats/totsComponentsTipusdeProducte/id
	 */
	@GET
