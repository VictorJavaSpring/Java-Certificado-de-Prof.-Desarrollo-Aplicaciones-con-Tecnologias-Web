 ...
 * S'expressa en un % de descompte en funci� del preu
 * i cada oferta tindr� data d'inici i fi de vig�ncia
 * @author Nacho
 *
 */
public class OfertaComanda {
	 ...
	 * Retornar� null si l'oferta no queda en la base de dades,
	 */
	public Long getId() {
		return nId;
	}
	 ...
	 * @param id es l'id que s'assignar� a la oferta.
	 * 
	 */
	 ...
	 * @return limitInferior es el l�mit inferior que t� l'oferta
	 */
	 ...
	 * @param limitInferior es el l�mit inferior que s'assignar�
	...
	public void setLimitInferior(Float limitInferior) {
		if (limitInferior == null || limitInferior < 0) {
			throw new IllegalArgumentException("El l�mit inferior ha de ser un n�mero positiu");
		}
	 ...
	 * @return pctDescompte es el % de descompte que t� l'oferta
	 */
	 ...
	 * @param pctDescompte es el % de descompte que s'assignar�
	...
	public void setPctDescompte(Float pctDescompte) {
		if (pctDescompte == null || pctDescompte < 0) {
			throw new IllegalArgumentException("El percentatge de descompte ha de ser un n�mero positiu");
		}
	 ...
	 * @return iniciVigencia es la data d'inici de vig�ncia de l'oferta
	 */
	...
	/**
	 * Assigna una data d'inici de vig�ncia a l'oferta
	...
	public void setIniciVigencia(Date iniciVigencia) {
		if (iniciVigencia == null || iniciVigencia.equals("")) {
			throw new IllegalArgumentException("La data d'inici de vig�ncia ha d'estar informada");
		}
	...
	/**
	 * 
	 * Retorna la data de fi de vig�ncia de l'oferta
	 * @return fiVigencia es la data de finalitzaci� de vig�ncia de l'oferta
	 */
	...
	/**
	 * Assigna una data de fi de vig�ncia a l'oferta
	...
	public void setFiVigencia(Date fiVigencia) {
		if (fiVigencia == null || fiVigencia.equals("")) {
			throw new IllegalArgumentException("La data de fi de vig�ncia ha d'estar informada");
		}
