...
public class VCuiner extends SeccioController {
	...
	public void VVistaCuiner(){
		// ewok.
		lComandaDAO = new LiniaComandaDAO(EWokController.getGlobalDatasource());
		// TODO afegeixo QUAN PUGUI els rols que poden usar aquest controller
	...
	public void doVeureLlista (HttpServletRequest request,
    	...
    	try {
    			lComanda = lComandaDAO.obtenirLiniaComandaEstatComanda();
